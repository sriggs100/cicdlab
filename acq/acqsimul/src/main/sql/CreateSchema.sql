create table jpa_sequences_table (sequence_name varchar(255) not null, next_val bigint, primary key (sequence_name)) engine=InnoDB;
insert into jpa_sequences_table(sequence_name, next_val) values ('transaction_log',150000000);
insert into jpa_sequences_table(sequence_name, next_val) values ('merchant',500000);
insert into jpa_sequences_table(sequence_name, next_val) values ('terminal',1500000);
insert into jpa_sequences_table(sequence_name, next_val) values ('transaction_emv_data',150000000);
create table merchant (id bigint not null, merchant_id varchar(15), name_and_location varchar(99), primary key (id)) engine=InnoDB;
...
create table terminal (id bigint not null, terminal_id varchar(8), merchant_id bigint, primary key (id)) engine=InnoDB;
create table transaction_emv_data (id bigint not null, application_expiration_date varchar(6), interface_device_serial_number varchar(8), terminal_capabilities tinyblob, primary key (id)) engine=InnoDB;
create table transaction_log (id bigint not null, action_code smallint, additional_data varchar(500), amount decimal(19,2) not null, application_transaction_counter varchar(4), authorisation_code varchar(6), card_acceptor_name_and_location varchar(99) not null, card_scheme integer not null, chip_data varchar(512), encrypted_expiry_date varchar(96), encrypted_pan varchar(96) not null, function_code smallint not null, merchant_category_code smallint not null, merchant_id varchar(15) not null, msg_type smallint not null, pan_hash varchar(64) not null, pan_sequence_number smallint not null, point_of_service_data_code varchar(12) not null, proc_code varchar(6) not null, reason_code smallint, stan integer not null, terminal_id varchar(8) not null, transaction_currency_code varchar(3), transaction_date_time varchar(12) not null, utc_capture_date_time datetime not null, transaction_emv_data_id bigint not null, primary key (id)) engine=InnoDB;
...
create table jpa_sequences_table (sequence_name varchar(255) not null, next_val bigint, primary key (sequence_name)) engine=InnoDB;
insert into jpa_sequences_table(sequence_name, next_val) values ('TransactionLog',130000000);
insert into jpa_sequences_table(sequence_name, next_val) values ('merchant',500000);
insert into jpa_sequences_table(sequence_name, next_val) values ('terminal',1500000);
insert into jpa_sequences_table(sequence_name, next_val) values ('TransactionEmvData',130000000);
create table merchant (id bigint not null, merchant_id varchar(15), name_and_location varchar(99), primary key (id)) engine=InnoDB;
create table merchant_terminals (merchant_id bigint not null, terminals_id bigint not null, primary key (merchant_id, terminals_id)) engine=InnoDB;
create table terminal (id bigint not null, terminal_id varchar(8), merchant_id bigint, primary key (id)) engine=InnoDB;
create table transaction_emv_data (id bigint not null, application_expiration_date varchar(6), interface_device_serial_number varchar(8), terminal_capabilities tinyblob, primary key (id)) engine=InnoDB;
